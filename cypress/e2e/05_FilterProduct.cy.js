...
describe("Filter Product", () => {
    ...
    it.only("F06- Filter with min price mixing letter and special characters", () => {
        //Filter Products
        const validPriceRange= filterProduct["validPriceRange"]
        const invalidPriceRange= filterProduct["invalidPriceRange"]
    ...
    it.only("F07- Filter with max price including letter characters", () => {
        //Filter Products
        const validPriceRange= filterProduct["validPriceRange"]
        const invalidPriceRange= filterProduct["invalidPriceRange"]
    ...
    it.only("F08- Filter with max price including special characters", () => {
        //Filter Products
        const validPriceRange= filterProduct["validPriceRange"]
        const invalidPriceRange= filterProduct["invalidPriceRange"]
    ...
    it.only("F09- Filter with max price mixing letter and special characters", () => {
        //Filter Products
        const validPriceRange= filterProduct["validPriceRange"]
        const invalidPriceRange= filterProduct["invalidPriceRange"]
