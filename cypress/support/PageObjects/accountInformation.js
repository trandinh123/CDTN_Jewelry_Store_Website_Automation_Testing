...
class AccountInfoPage{
    ...
    EditAddress(FirstName, LastName, Company, Address1, Address2, City, Country, ZIPCode, Phone) {
        ...
        cy.xpath(accountLocator.EditAddress_First_Name_Input).eq(1).clear().type(FirstName)
        cy.xpath(accountLocator.EditAddress_Last_Name_Input).eq(1).clear().type(LastName)
        cy.xpath(accountLocator.EditAddress_Company_Input).eq(1).clear().type(Company)
        cy.xpath(accountLocator.EditAddress_Address1_Input).eq(1).clear().type(Address1)
        cy.xpath(accountLocator.EditAddress_Address2_Input).eq(1).clear().type(Address2)
        cy.xpath(accountLocator.EditAddress_City_Input).eq(1).clear().type(City)
        //cy.xpath(accountLocator.EditAddress_Country_Selection).select(Country)
        cy.xpath(accountLocator.EditAddress_ZIPCode_Input).eq(1).clear().type(ZIPCode)
        cy.xpath(accountLocator.EditAddress_Phone_Input).eq(1).clear().type(Phone)
    }
